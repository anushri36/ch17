...
cursor = cursor.execute("""INSERT INTO authors (first, last)
                            VALUES ('Sue', 'Red')""")
print("\nQuestion 17.1.d")
print("Total 'authors' database including new author 'Sue Red':")
...
cursor = cursor.execute("""INSERT INTO author_ISBN (id, isbn)
                            VALUES (6, 7382593059)""")
print("\nQuestion 17.1.e")
print("Total 'titles' database including new title 'Python 101':")
print(pd.read_sql('SELECT * FROM titles', connection))
print("\nTotal 'authors_ISBN' database including new author's id and new title's ISBN:")
